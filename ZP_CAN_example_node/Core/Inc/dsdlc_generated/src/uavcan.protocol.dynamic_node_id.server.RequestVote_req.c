...
#include "dsdlc_generated/include/uavcan.protocol.dynamic_node_id.server.RequestVote_req.h"

#include "dsdlc_generated/include/uavcan.protocol.dynamic_node_id.server.RequestVote_res.h"
