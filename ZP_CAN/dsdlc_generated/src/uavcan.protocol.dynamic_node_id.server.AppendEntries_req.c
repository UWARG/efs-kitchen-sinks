...
#include "../../../dsdlc_generated/include/uavcan.protocol.dynamic_node_id.server.AppendEntries_req.h"

#include "../../../dsdlc_generated/include/uavcan.protocol.dynamic_node_id.server.AppendEntries_res.h"
