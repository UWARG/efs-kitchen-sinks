...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(CAN_TERM_EN_GPIO_Port, CAN_TERM_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : CAN_TERM_EN_Pin */
  GPIO_InitStruct.Pin = CAN_TERM_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAN_TERM_EN_GPIO_Port, &GPIO_InitStruct);
